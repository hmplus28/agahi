@extends('layouts.app',['title'=>'تأیید ثبت آگهی | '.config('app.name'),'robots'=>'noindex, nofollow'])
@section('content')
<section class="form-page">
    ...
    <div class="auth-tabs">
        <div id="tab-login" class="tab-content active">
            <form method="post" action="{{ route('guest.ad.process', $token) }}">
                @csrf
                <input type="hidden" name="action" value="login">
                <div class="form-grid">
                    <label class="wide">شماره موبایل
                        <input type="text" name="mobile" value="{{ old('mobile', $adData['mobile_1'] ?? '') }}" inputmode="numeric" placeholder="09123456789" required>
                    </label>
