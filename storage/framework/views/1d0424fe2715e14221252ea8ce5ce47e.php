...
<header class="site-header" role="banner">
    ...
    <div class="container header-top">
        ...
        <a class="brand" href="<?php echo e(route('home')); ?>" aria-label="صفحهٔ اصلی <?php echo e(config('app.name')); ?>">
            ...
            <img class="brand-logo" src="/img/logo.png" alt="<?php echo e(config('app.name')); ?>" onerror="this.style.display='none';document.querySelector('.brand-mark').style.display='inline-flex'">
        </a>
    ...
    <div class="container header-bottom">
        ...
        <a class="header-phone" href="tel:<?php echo e(config('agahi.support_phone_href')); ?>" dir="ltr">
            ...
            <span>تبلیغات: <?php echo e(to_persian_digits(config('agahi.support_phone'))); ?></span>
        </a>
...
</html><?php /**PATH /home/z/my-project/agahi/resources/views/layouts/app.blade.php ENDPATH**/ ?>