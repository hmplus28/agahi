...
<?php endif; ?>
            ...
            <label>کشور
                <select name="country_id" id="guest-country" data-cascade-country>
                    ...
                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($country->id); ?>" <?php if(old('country_id', ($country->slug ?? '') === 'iran' ? $country->id : '')==$country->id): echo 'selected'; endif; ?>><?php echo e($country->name); ?></option>
            ...
            <label><span>موبایل <span class="req">*</span></span>
                <div class="input-row">
                    <input name="mobile_1" value="<?php echo e(old('mobile_1')); ?>" inputmode="numeric" placeholder="09123456789" required>
            ...
            <label>موبایل همراه (تکراری برای تماس)
                <input name="hamrah_1" value="<?php echo e(old('hamrah_1')); ?>" inputmode="numeric" placeholder="09123456789">
            </label>
            ...
            <label class="wide">معرف
                <input name="referrer" value="<?php echo e(old('referrer')); ?>" maxlength="160" placeholder="نام کسی که شما را معرفی کرده است">
            </label>
...
<?php echo $__env->make('layouts.app',['title'=>'ثبت آگهی | '.config('app.name'),'robots'=>'noindex, nofollow'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/z/my-project/agahi/resources/views/guest/ad-create.blade.php ENDPATH**/ ?>